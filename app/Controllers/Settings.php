...
class Settings extends Security_Controller {
    ...
    function notifications() {
        ...
        try {
            $notification_config = app_hooks()->apply_filters('app_filter_notification_config', array());
            if ($notification_config && get_array_value($notification_config, "category_suggestion")) {
                $category_suggestions[] = get_array_value($notification_config, "category_suggestion");
            }
        } catch (\Exception $ex) {
