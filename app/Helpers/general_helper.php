...
if (!function_exists('prepare_invoice_pdf')) {
    ...
    function prepare_invoice_pdf($invoice_data, $mode = "download") {
        ...
        if ($invoice_data) {
            ...
            // $invoice_data['qr_code'] = 
            $invoice_id=  json_decode(json_encode($invoice_data['invoice_info']->id));
           $qrCode = new QrCode();
                
           $code_url =get_uri('home/download_pdf/'.$invoice_id.'/view');
           ...
           $qr_code='<img src="data:'.$qrCode->getContentType().';base64,'.$qrCode->generate().'" />';
           $invoice_data["qr_code"] = $qr_code;
